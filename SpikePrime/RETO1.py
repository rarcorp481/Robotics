...
async def main():
   ...
   #Bloque 2: Movimiento para retroceder y jalar el bloque rojo
    ...
    await retroceder_cm(5)
    await pausa(0.5)
    await girar_izquierda_fase(180)
    await pausa(0.5)
    await avanzar_cm(50)
    await pausa(0.5)
    await subir_garra()
    ...
    #Bloque 3: girar y avanzar hacia el objetivo
    await girar_izquierda_fase(200,70)
    await pausa(0.5)
    await avanzar_cm(100)
    await pausa(0.5)
    
    #Bloque 4: Dejar el bloque en el espacio indicado
    await subir_garra()
